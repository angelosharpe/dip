...
\chapter{Bayesovský klasifikátor} \label{SF-BAYES}
...
\chapter{Tokenizace a výbìr vhodných pøíznakù}
...
\section{Speciální pøíznaky v textu}
...
V této kapitole se budeme zabývat implementací jednotlivých algoritmù z kapitoly SF a nástroji pou¾itými k jejich implementaci.
