...
class Entry:
    def __init__(self, id, guid, entry, language):
        ...
        self.word_list = self._to_words(entry, language)
    ...
    def _to_words(self, entry, language):
        '''
        This method splits entry into sentences and those sentences into words.
        Very simple spliting on non-alphanumeric characters.'
        '''
        word_list = []
